// Domain/Constants/Taxonomy.cs - Port of taxonomy.py
namespace HigenAbsa.Domain.Constants;

public static class Taxonomy
{
    /// <summary>Maps micro aspect name to its parent macro category.</summary>
    public static readonly IReadOnlyDictionary<string, string> MicroToMacro =
    ...
    /// <summary>Vietnamese descriptive text for each micro aspect.</summary>
    public static readonly IReadOnlyDictionary<string, string> MicroText =
        new Dictionary<string, string>
        {
    ...
    /// <summary>Business recommendations for each micro aspect (negative cases).</summary>
    public static readonly IReadOnlyDictionary<string, string> MicroRecommendations =
        new Dictionary<string, string>
        {
    ...
    /// <summary>Micro aspects excluded from insight generation.</summary>
    public static readonly IReadOnlySet<string> InsightIgnoredMicros =
        new HashSet<string> { "Spam_Noise", "Intent_QA" };
}
