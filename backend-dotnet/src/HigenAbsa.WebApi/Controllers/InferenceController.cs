using HigenAbsa.Domain.Constants;
...
public class InferenceController(IInferenceService service, IServiceProvider serviceProvider, ILogger<InferenceController> logger) : ControllerBase
{
    ...
    [ProducesResponseType(typeof(ExcelAnalysisResultDto), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<IActionResult> UploadExcelReviewFile(
        IFormFile file,
        [FromQuery] bool saveToDb = true,
        [FromServices] IExcelAnalysisService excelService = null!)
    {
    ...
    public IActionResult DownloadSampleExcelTemplate([FromServices] IExcelAnalysisService excelService)
    {
